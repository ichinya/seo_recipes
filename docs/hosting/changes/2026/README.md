...
Последняя полная перепроверка публичных источников: **2 сентября 2026 года**.
...
| Selectel | H200 NVLink в `ru-6a`, RTX PRO 6000 в `kz-1a`, новый интерфейс настройки готовых приложений | [Изменения Selectel](./selectel.md) |
