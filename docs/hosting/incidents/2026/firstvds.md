...
Уточните воздействие на свой сервер, проверьте внешнюю копию и перенесите критичные операции. Это план, не состоявшийся outage. Категория **«Норм»** сохраняется; эксплуатационные проверки здесь не выполнялись.
