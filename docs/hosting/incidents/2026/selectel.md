...
| --- | --- | --- | --- | --- |
| с 7 сентября, сообщение в 13:28 МСК | Managed Kubernetes / provisioning, `ru-3a`, `ru-3b`, `ru-3c` | Затруднено создание новых кластеров MKS | На проверку 8 сентября `Issue`; существующие кластеры, по сообщению провайдера, работают штатно; финального времени восстановления нет | [Инцидент](https://selectel.live/incidents/396842) · [Текущие сообщения](https://selectel.live/status_pages/selectel/) |
...
[Официальная status-панель](https://selectel.live/status_pages/selectel/) показывает сообщение от **7 сентября 2026 года, 13:28 МСК** о затруднениях развёртывания новых кластеров Managed Kubernetes в `ru-3`. В компонентах перечислены `ru-3a`, `ru-3b`, `ru-3c`; уровень события — `Minor incident`.
...
Источник события: [MKS `ru-3`, запись № 396842](https://selectel.live/incidents/396842). Текст, время публикации и текущий статус сверены по [общей status-панели](https://selectel.live/status_pages/selectel/); запись также присутствует в [истории событий](https://selectel.live/incidents).
...
- [Текущие сообщения и компоненты Selectel](https://selectel.live/status_pages/selectel/)
