...
| 19 августа | `spb-1`, `spb-3` и зависимые сервисы | Утром live-панель показывала частичную доступность облачных серверов и связанных сервисов; позднее все сервисы отображались доступными | Не опубликована | Восстановлено при повторной проверке | [Официальная live-панель](https://timeweb.cloud/live) |
...
Причиной назван программный дефект в низкоуровневого кода СХД. Он запускал циклические перезапуски узлов хранения и создавал дополнительную нагрузку на шину данных. К 10:30 10 апреля кластер был стабилизирован, после чего восстановительные операции продолжались примерно до 17:30.
