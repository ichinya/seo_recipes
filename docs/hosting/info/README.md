...
Здесь лежат общие статьи о хостингах, рыночных рисках, критериях оценки и требованиях к размещению данных, а также практические инструкции по миграции и использованию сервисов провайдеров.

## Материалы

| Тема | Кратко | Материал |
| --- | --- | --- |
| Закрытие Yandex Serverless Integrations | Календарь, миграция EventRouter на триггеры и безопасная проверка доставки событий | [EventRouter: миграция в 2026 году](./yandex-serverless-integrations-sunset-2026.md) |
