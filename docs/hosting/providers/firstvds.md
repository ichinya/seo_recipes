...
## Техподдержка и время ответа

По данным FirstVDS на 12 июля 2026 года, служба поддержки работает круглосуточно, без выходных и праздников, а среднее время ответа на запрос из личного кабинета составляет 15 минут. Обратиться можно через чат, тикет в личном кабинете или по телефону. Бесплатная техническая поддержка консультирует по управлению услугами, активации и первичной настройке сервера.

Важно отделять консультацию поддержки от администрирования сервера. Установка ПО, диагностика пользовательской конфигурации и другие работы на самом VDS могут быть платными. На публичной странице указан пакет администрирования за 900 рублей в месяц: в него входят 5 задач, дополнительная задача стоит 300 рублей, а разовая задача без пакета - 500 рублей. В форме заказа пакета также указано максимальное время ответа 24 часа, при этом, по статистике провайдера, 95% вопросов обрабатываются в течение часа.

### Обращение по поводу смены IP-адреса

12 июля 2026 года при попытке поменять основной IP сервера по ошибке был заказан дополнительный IPv4. В кабинете появился второй активный адрес, а удалить его сразу не получилось: система сообщила о минимальном периоде использования в один месяц. Цена дополнительного IPv4 составляла 180 рублей в месяц, а первое суточное списание в июле - 5,8064 рубля, то есть `180 / 31`.

Поддержка объяснила, что замена основного IP выполняется как отдельная платная работа за 1000 рублей. На время замены сервер будет недоступен примерно 30-60 минут; работы можно заранее запланировать на ночное окно. Для выполнения потребовались бы деньги на балансе и временная безопасная передача root-пароля через сервис одноразовых секретов.

После уточнения ситуации поддержка согласилась в порядке исключения удалить ошибочно заказанный дополнительный IP до окончания минимального месячного периода. Возврат уже списанной суточной суммы в переписке отдельно не подтверждался.

Фактическое время ответов в этом обращении:

| Этап | Время |
| --- | ---: |
| первый ответ после создания запроса | 4 минуты 57 секунд |
| ответ на уточняющий вопрос | 2 минуты 24 секунды |
| удаление IP после подтверждения | 1 минута 26 секунд |
| весь диалог от первого сообщения до результата | 13 минут 46 секунд |

Этот случай показывает две стороны сервиса: механизм самостоятельной смены основного IP в кабинете неочевиден, а сама замена оказалась платной, но сотрудники отвечали заметно быстрее заявленных средних 15 минут и пошли навстречу при отмене ошибочного заказа.

### Пример обращения по аккаунту
...
- в проверенном обращении первый ответ пришел менее чем за 5 минут, а вопрос решили менее чем за 14 минут;
...
- самостоятельный заказ дополнительного IPv4 не заменяет основной адрес, а штатная замена основного IP через поддержку стоит 1000 рублей и требует перерыва в работе сервера;
...
- [Служба поддержки FirstVDS](https://firstvds.ru/technology/support)
- [Администрирование и дополнительные услуги](https://firstvds.ru/services/support)
