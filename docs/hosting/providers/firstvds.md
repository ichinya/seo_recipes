...
## Переезд Амстердама в NorthC Amsterdam 1

13 июля FirstVDS объявил срочный уход из Qupra DC2 после повторных аварий охлаждения. Провайдер объяснил решение тем, что старая площадка продолжала работать на резервном чиллере без резервного питания, и выбрал NorthC Amsterdam 1, описываемый как дата-центр уровня Tier III.

В промежуточном обновлении от 27 августа FirstVDS сообщал, что:

- миграция идёт по графику без заявленных сбоев и задержек;
- IP-адреса клиентов сохраняются;
- DNS и конфигурацию проектов менять не требуется;
- работы проводятся с минимальным воздействием на сервисы.

**31 августа 2026 года FirstVDS официально сообщил о завершении переноса виртуальных машин из Qupra DC2 в NorthC Amsterdam 1.** Новые VDS в Нидерландах уже создаются на новой площадке.

Это положительный follow-up после инцидентов Qupra: провайдер опубликовал постмортем, объявил corrective action и завершил физическую миграцию. Однако сам факт переезда ещё не даёт длительной статистики эксплуатации NorthC.

После миграции полезно повторить:
...
Результаты старых тестов на другой площадке не описывают NorthC полностью. Категорию **«Норм»** пока менять не нужно: известный риск старого ЦОД снижен, но необходимы post-migration наблюдение и повторные проверки.
...
- после аварий Qupra опубликован постмортем и завершён перенос в другую площадку с сохранением IP.
...
- у новой площадки NorthC пока нет длительной публичной истории эксплуатации в рамках FirstVDS;
...
- создаётся ли новый нидерландский VDS именно в NorthC Amsterdam 1;
...
- сеть, latency и производительность дисков на NorthC после переезда;
- внешний restore-test после физической миграции.
...
Переезд из Qupra DC2 в NorthC Amsterdam 1 официально завершён и снижает известный инфраструктурный риск. Повышать категорию до «Рекомендую» только по факту смены площадки рано: нужны post-migration замеры и наблюдение за стабильностью NorthC.
