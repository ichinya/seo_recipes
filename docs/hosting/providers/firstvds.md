...
13 июля FirstVDS объявил срочный уход из Qupra DC2 после повторных аварий охлаждения. Провайдер объяснил решение тем, что старая площадка продолжала работать на резервном чиллере без резервного питания, и выбрал NorthC Amsterdam 1 уровня Tier III.

По официальному обновлению от 27 августа:

- миграция шла по графику без заявленных сбоев и задержек;
- завершение планировалось к началу сентября 2026 года;
...
Это положительный follow-up после инцидентов Qupra: провайдер не только опубликовал постмортем, но и меняет физическую площадку. Однако на 29 августа переезд ещё нельзя считать официально завершённым.

После финального сообщения полезно повторить:
...
Результаты старых тестов на другой площадке не описывают NorthC полностью. Категорию **«Норм»** пока менять не нужно: направление исправления верное, но необходимы подтверждение завершения и post-migration наблюдение.
...
- после аварий Qupra опубликован постмортем и начат перенос в другую площадку с сохранением IP.
...
- миграция Амстердама на 29 августа ещё не подтверждена как завершённая;
...
- завершён ли перенос конкретного амстердамского сервера в NorthC Amsterdam 1;
...
- изменились ли сеть и производительность после переезда.
...
Переезд из Qupra DC2 в NorthC Amsterdam 1 снижает известный инфраструктурный риск, но повышать категорию до «Рекомендую» рано до завершения работ и повторных тестов новой площадки.
