...
В принципе его можно заблокировать, как [AmazonBot](./amazon_bot.md) или воспользоваться готовыми [правилами для блокировки ChatGPT, Claude и Gemini](./block_chatgpt_claude_gemini.md). Нужно прописать в .htaccess:
